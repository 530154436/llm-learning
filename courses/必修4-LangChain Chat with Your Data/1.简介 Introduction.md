...
在本课程中，我们学习如何使用LangChain和自有数据进行对话。即`检索增强生成`（Retrieval Augmented Generation，RAG）。
在检索增强生成（RAG）中，大型语言模型（LLM）在执行过程中会从外部数据集中检索上下文文档。

<img src="../figures/必修4/1-overview.png" alt="Tokens" width="80%" height="80%"/>
