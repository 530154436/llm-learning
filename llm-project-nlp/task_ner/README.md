...
| Qwen2.5-7B-Instruct + LoRA(peft,user)        | 0.629   | 0.823 | 0.804   | 0.875 | 0.834  | 0.837 | 0.902 | 0.795 | 0.791    | 0.624 | 0.795     |
| Qwen2.5-7B-Instruct + LoRA(peft,system+user) | 0.643   | 0.828 | 0.820   | 0.885 | 0.862  | 0.850 | 0.889 | 0.795 | 0.805    | 0.663 | 0.805     |
...
+ Qwen2.5-7B-Instruct + Lora（peft,user）
```
       Label Precision  Recall     F1
...
+ Qwen2.5-7B-Instruct + Lora（peft,system+user）
```
       Label Precision  Recall     F1
       scene    0.6961  0.6332 0.6632
    position    0.8164  0.7953 0.8057
organization    0.8042  0.7878 0.7959
        name    0.8721  0.9069 0.8891
       movie    0.8905  0.8133 0.8502
  government    0.8405  0.8852 0.8623
        game    0.8449  0.9303 0.8856
     company    0.8219  0.8197 0.8208
        book    0.8153  0.8421 0.8285
     address    0.6237  0.6648 0.6436
  Micro Avg.    0.8007  0.8112 0.8059
  Macro Avg.         -       - 0.8045
```
